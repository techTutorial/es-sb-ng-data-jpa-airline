...
-- optional: when no SCHEMA reference is available;
CREATE SCHEMA SCHEMA AUTHORIZATION SA;



DROP TABLE IF EXISTS SCHEMA.USER_ENTITY;

create table SCHEMA.USER_ENTITY (
...
DROP TABLE IF EXISTS SCHEMA.EMPLOYEE_ENTITY;

create table SCHEMA.EMPLOYEE_ENTITY (
...
COMMENT ON COLUMN SCHEMA.EMPLOYEE_ENTITY.TYPE_PREF_CONTACT_EMP IS 'Preferred way to contact with employee';
